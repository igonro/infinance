					...
					<thead>
						<tr>
							<th data-toggle="tooltip"
								title="Número que identifica una transacción.">ID de
								transacción</th>
							<th data-toggle="tooltip"
								title="Código alfanumérico que identifica las acciones de la empresa.">Símbolo</th>
							<th data-toggle="tooltip"
								title="Número de acciones adquiridas o vendidas.">Número de
								acciones</th>
							<th data-toggle="tooltip" title="Precio de cada acción.">Precio
								unitario</th>
							<th data-toggle="tooltip"
								title="Precio total del conjunto de acciones.">Precio total</th>
