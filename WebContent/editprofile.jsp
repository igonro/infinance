  ...
  <div class="container-fluid">
      <div class="row">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item ">
                <a class="nav-link active" href="#">
                  <span data-feather="settings"></span> Configuración <span class="sr-only">(actual)</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <h2>Perfil</h2>
              <form class="form-register text-center" action="/infinance/settings" method="post">
      ...
      <input id="inputEmail" class="form-control" placeholder="" required="true" autofocus="" type="email" name="email"  value = "${userinfo.email}">
             <button id="registerButton" class="btn btn-lg btn-primary btn-block" type="submit">Editar</button>
