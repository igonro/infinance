          			...
          			<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            			...
            			<div class="btn-toolbar mb-2 mb-md-0">
              				<div class="btn-group mr-2">
                				<button id="add-to-portfolio" class="btn btn-sm btn-outline-success">Añadir a mi cartera</button>
              				</div>
              				<form class="form-date text-center" action="/infinance/company" method="get">
	              				<div class="btn-group mr-2">
	                				<input class="btn btn-sm btn-outline-secondary" type="date" id="dateStart" name="dateStart" step="1" value="${Dates.dateStart}" disabled>
	              				</div>
	              				<div class="btn-group mr-2">
	                				<input class="btn btn-sm btn-outline-secondary" type="date" id="dateEnd" name="dateEnd" step="1" value="${Dates.dateEnd}" disabled>
	              				</div>
