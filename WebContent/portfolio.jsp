        		...
        		<nav class="col-md-2 d-none d-md-block bg-light sidebar">
          			<div class="sidebar-sticky">
            			<ul class="nav flex-column">
              				<li class="nav-item">
                				<a class="nav-link active" href="#"><span data-feather="briefcase"></span> Mi cartera<span class="sr-only">(actual)</span></a>
                			</li>
                			<li class="nav-item">
            			...
            			<table id="portfoliotable" class="table table-striped table-sm">
              				<thead>
                				<tr>
									...
									<th data-toggle="tooltip" title="Número de acciones en posesión.">Número de acciones</th>
									<th data-toggle="tooltip" title="Cantidad total de dinero invertido en acciones. &#10;NOTA: También se tiene en cuenta el dinero invertido en acciones ya vendidas.">Coste</th>
									<th data-toggle="tooltip" title="Cantidad total de dinero obtenido tras la venta de acciones.">Venta</th>
									<th data-toggle="tooltip" title="Valor total de las acciones en posesión.">Valor</th>
									<th data-toggle="tooltip" title="Cantidad total de beneficios que se han obtenido hasta la fecha suponiendo que se vendiesen hoy todas las acciones en posesión.">Balance</th>
									<th></th>
									<th></th>
                				</tr>
              				</thead>
