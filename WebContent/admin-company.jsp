	...
	<div class="container-fluid">
		<div class="row">
			...
			<div
				...
				<div class="btn-toolbar mb-2 mb-md-0" style="padding-right : 25px;">
					<div class="btn-group mr-2">
						<button class="btn btn-add btn-lm btn-outline-success" id="addcompany">
						Añadir</button>
					</div>
				</div>
			</div>
			...
			<div class="table-responsive">
				<table id="companytable"
					class="table table-hover table-responsive table-editable w-100 d-block d-md-table">
					<thead>
						<tr>
					...
					<tbody>
						<c:forEach var="Empresas" items="${Empresas}">
							<tr>
								...
								<td>
									<button class="btn-edit btn-sm btn-outline-primary"
								...
								<td>
									<form action="/infinance/admin-company" method="post">
										...
										<button id="deletecompany"
											class="btn-sale btn-sm btn-outline-danger" type="submit">
											Eliminar</button>
									</form>
								</td>
							</tr>
	...
	<div id="addcompanydialog" class="dialog" title="Añadir Empresa">
		<div class="container">
			<form id="addpopupform" action="/infinance/admin-company" method="post">
				...
				<label for="marketCap" class="control-label">Valor de
					mercado</label>
				<input id="marketCap" class="form-control"
					placeholder="Valor de mercado" required="true" type="text"
					name="marketCap">
				<label for="adrtso" class="control-label">Adrtso</label>
				<input id="adrtso" class="form-control" placeholder="adrtso"
					required="true" type="text" name="adrtso">
				<label for="ipoyear" class="control-label">Ipoyear</label>
				<input id="ipoyear" class="form-control" placeholder="ipoyear"
					required="true" type="text" name="ipoyear">
				<label for="sector" class="control-label">Sector</label>
				<input id="sector" class="form-control" placeholder="Sector"
					required="true" type="text" name="sector">
				<label for="industry" class="control-label">Industry</label>
				<input id="industry" class="form-control" placeholder="Industry"
					required="true" type="text" name="industry">
				<label for="summary" class="control-label">Summary</label>
				<input id="summary" class="form-control" placeholder="Summary"
					required="true" type="text" name="summary">
				<label for="lastsale" class="control-label">Last sale</label>
				<input id="lastsale" class="form-control" placeholder="lastsale"
					required="true" type="text" name="lastsale">
				<input id="type" class="form-control" type="hidden" name="type"
					value="add">
				</br>
				<button id="addbutton" class="btn btn-lg btn-primary btn-block"
	...
	<div id="editcompanydialog" class="dialog" title="Editar Empresa">
		<div class="container">
			<form id="editpopupform" action="/infinance/admin-company" method="post">
				...
				<input id="sectoredit" class="form-control" placeholder="Sector"
					required="true" type="text" name="sectoredit">
				<label for="industryedit" class="control-label">Industry</label>
				<input id="industryedit" class="form-control" placeholder="Industry"
					required="true" type="text" name="industryedit">
				<input id="type" class="form-control" type="hidden" name="type"
					value="edit">
				</br>
				<button id="editbutton" class="btn btn-lg btn-primary btn-block"
